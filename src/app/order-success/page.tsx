          ...
          <div className="flex items-center gap-4 px-6 py-5 bg-[#f7fbfb] border-b border-slate-100">
            ...
            <div className="ml-auto text-right">
              ...
              <div className="text-lg font-semibold text-[#065975]">
                {order ? currency(order.orderTotal) : quickTotal ? currency(quickTotal) : "—"}
              </div>
            </div>
          </div>
                ...
                <div className="mt-4 border rounded-lg p-4 bg-[#fbffff]">
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <div className="flex items-center justify-between text-sm font-semibold text-[#065975] mt-2 border-t pt-2">
                      <div>Total</div>
                      <div>{currency(order?.orderTotal ?? (quickTotal ?? subtotalAmount() + (order?.quotedDeliveryCharge ?? 0)))}</div>
                    </div>
                  </div>
                </div>
          ...
          <div className="px-6 py-4 border-t border-slate-100 bg-white/50 flex items-center justify-between gap-3">
            <div className="text-xs text-slate-500 flex items-center gap-2">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" aria-hidden>
                <path d="M3 12h18" stroke="#94a3b8" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M12 3v18" stroke="#94a3b8" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              Track your order anytime in Orders
            </div>
